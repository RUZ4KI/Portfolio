        ...
        <SimpleGrid columns={[1, 1, 2]} gap={6}>
          <Section>
            <WorkGridItem
              ...
              thumbnail={movieDatabase}
            >
              A movie database site that allows you to view data of various
              movies like budget, rating etc.
            </WorkGridItem>
          </Section>
          <Section>
            <WorkGridItem
            ...
            >
              A covid tracker site that allows you to moniter data of various
              countries.
            </WorkGridItem>
          </Section>
          <Section>
